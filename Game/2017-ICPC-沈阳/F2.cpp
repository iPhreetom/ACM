...
void init(){
    ...
    while(a.back() < maxn){
        a.push_back(a.back()*four - a[a.size()-2]);
    }
}
...
int main()
{
   ...
   int t;
   cin>>t;
   a.push_back((Bignum(4)));
   a.push_back((Bignum(14)));
   a.push_back((Bignum(52)));
   a.push_back((Bignum(194)));
   a.push_back((Bignum(724)));
   a.push_back((Bignum(2702)));
   a.push_back((Bignum(10084)));
   a.push_back((Bignum(37634)));
   init();
   // for (int i=0; i<10; i++){
   //     cout<<a[i]<<endl;
   // }
